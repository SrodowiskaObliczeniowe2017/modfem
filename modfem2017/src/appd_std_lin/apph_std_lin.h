/************************************************************************
File apph_std_lin.h - internal information for parallel overlap for
   approximation module for std_lin approximation and prismatic elements       
...
#ifndef _apph_std_lin_
#define _apph_std_lin_
